...
Metric <- "Percentage of 5-year olds achieving 'expected level' in communication early learning goals"

# Metric_short is the name that the sheet will be in the human readable and jitter input files
Metric_short <- "EarlyYearsFoundationComms" 
...
scraped_values['Variable Name'] = "Percentage of 5-year olds achieving 'expected level' in communication early learning goals (%)"
