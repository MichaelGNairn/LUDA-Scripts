...
Metric <- "Percentage of 5-year olds achieving 'expected level' in literacy early learning goals"

# Metric_short is the name that the sheet will be in the human readable and jitter input files
Metric_short <- "EarlyYearsFoundationLiteracy" 
...
scraped_values['Variable Name'] = "Percentage of 5-year olds achieving 'expected level' in literacy early learning goals (%)"
