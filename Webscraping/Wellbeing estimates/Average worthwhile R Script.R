...
Metric <- "Average feeling that things done in life are worthwhile ratings"

# Metric_short is the name that the sheet will be in the human readable and jitter input files
Metric_short <- "Worthwhile" 
...
scraped_values['Variable Name'] = "Average feeling that things done in life are worthwhile rating (score out of 10)"

scraped_values$AREANM <- gsub("ireland2,3", "ireland", as.character(scraped_values$AREANM))
