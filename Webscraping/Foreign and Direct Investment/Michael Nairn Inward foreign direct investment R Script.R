...
scraped_data <- "https://www.ons.gov.uk/economy/nationalaccounts/balanceofpayments/datasets/foreigndirectinvestmentinvolvingukcompaniesbyukcountryandindustrydirectionalinward"

scraped_data <- "https://www.ons.gov.uk/file?uri=/economy/nationalaccounts/balanceofpayments/datasets/foreigndirectinvestmentinvolvingukcompaniesbyukcountryandindustrydirectionaloutward/current/subnationalfdiinwardtablesfinal.xls"

filename <- "subnationalfdiinwardtablesfinal.xls"
...
scraped_data <- filter(scraped_data, ...3 == "Total foreign fdi international investment position in the uk at end period")
...
scraped_values['Variable Name'] = "Inward Foreign Direct Investment (£ million)"
