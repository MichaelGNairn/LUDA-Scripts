...
scraped_values <- filter(scraped_data, apprenticeships_or_further_education == "Further education and skills"
...
scraped_values['Measure']="Rate per 100, 000 population"
scraped_values['Unit']="per 100, 000 population" # likely a % or £. Be careful.
...
scraped_values['Variable Name'] = "19+ further education and skills participation"
...
scraped_clean <- rename(scraped_areas, Period = "time_period",
                        Value = "participation_rate_per_100000_population")
...
# For this iteration (August 2022) remove 202122 data as it is incomplete.
csv_output <- filter(csv_output, Period != "202122")
