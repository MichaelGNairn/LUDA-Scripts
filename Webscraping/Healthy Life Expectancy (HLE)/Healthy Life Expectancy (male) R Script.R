...
#### Filter by sex = male, age = <1, and rename and select relevant columns ####

scraped_data <- filter(scraped_data, Sex == "Male" & `Age group` == "<1")
...
scraped_values['Variable Name'] = "Male Healthy Life Expectancy (years)"
...
# e.g. D:/Coding_Repos/LUDA-Scripts") # please note this path will be specific for your local drive
