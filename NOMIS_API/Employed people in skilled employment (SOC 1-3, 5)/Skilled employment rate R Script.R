#### Michael Nairn Subnational Statistics skilled employment rate R Script ####
...
csv_formatted <- (na.omit(csv_formatted)) # removes NAs - if necessary
